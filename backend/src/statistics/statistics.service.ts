...
export class StatisticsService {
  ...
  async getMainStatistics(storeId: string) {
    ...
    const productsCount = await this.calculateProductsCount(storeId);
    ...
    return [
      ...
      { id: 2, name: 'Количество продуктов', value: productsCount },
  ...
  private async calculateProductsCount(storeId: string) {
