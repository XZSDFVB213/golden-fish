-- CreateEnum
CREATE TYPE "TransactionType" AS ENUM ('DEPOSIT', 'WITHDRAW', 'PURCHASE', 'REFUND', 'TRANSFER');

-- CreateEnum
CREATE TYPE "TransactionStatus" AS ENUM ('PENDING', 'SUCCESS', 'FAILED');

-- CreateEnum
CREATE TYPE "EnumOrderStatus" AS ENUM ('PAYED', 'PENDING');

-- CreateEnum
CREATE TYPE "RoleUser" AS ENUM ('ADMIN', 'MANAGER', 'BUYER');
...
CREATE TABLE "user" (
    ...
    "role" "RoleUser" NOT NULL DEFAULT 'BUYER',
